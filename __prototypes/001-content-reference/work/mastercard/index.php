...
<head>    
    <title>Mastercard Cashless Pioneers, a SuperFriendly collaboration</title>
...
<body>
    ...
    <div class="clearfix">
        ...
        <div class="main">
            ...
            <section class="wf">
                <p>Do you have a project similar to MasterCard Cashless Pioneers that you need help with? We&rsquo;d love to talk to you about it. <a href="<?=$basepath?>/contact/">Get in touch</a>.</p>
            </section>

            <nav class="pagination clearfix">
                <ul>
                    <li><a href="<?=$basepath?>/work/entertainment-weekly/">Prev</a></li>
                    <li><a href="<?=$basepath?>/work/moodpik/">Next</a></li>
                </ul>
            </nav><!-- .pagination -->
