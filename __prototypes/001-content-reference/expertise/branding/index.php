...
<head>    
    <title>SuperFriendly&rsquo;s Expertise in &ldquo;Branding&rdquo;</title>
    ...
    <div class="clearfix">
        ...
        <div class="main">
            ...
            <section class="wf" style="height: 20em;">
                <h2>Why Branding is an important service we offer</h2>
            </section>

            <section class="wf" style="height: 20em;">
                <h2>Statistics about the importance of Branding</h2>
            </section>

            <section class="wf">
                <h2>Examples of our Branding work</h2>
            ...
            <section class="wf">
                <p>Do you have a project that needs expert Branding? We&rsquo;d love to talk to you about it. <a href="<?=$basepath?>/contact/">Get in touch</a>.</p>
            </section>

            <nav class="pagination clearfix">
                <ul>
                    <li><a href="<?=$basepath?>/expertise/mobile/">Prev</a></li>
